...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM profiles WHERE id = 'd7bed83c-882c-4764-a6b0-8fdf36d47917') THEN
...
-- Insert sample beneficiaries if they don't exist
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM beneficiaries WHERE id = 'b1d9e4c2-6f3a-5e2b-9c8d-7a4b3f2e1d0c') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM transactions WHERE user_id = 'd7bed83c-882c-4764-a6b0-8fdf36d47917' AND created_at = '2025-02-15 09:24:00+00') THEN
...
-- Insert sample bills if they don't exist
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM bills WHERE user_id = 'd7bed83c-882c-4764-a6b0-8fdf36d47917' AND account_number = '12345-6789') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM notifications WHERE user_id = 'd7bed83c-882c-4764-a6b0-8fdf36d47917' AND created_at = '2025-02-15 09:25:00+00') THEN
